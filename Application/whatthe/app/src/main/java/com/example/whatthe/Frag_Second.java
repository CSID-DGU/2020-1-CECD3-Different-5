...
public class Frag_Second extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater Inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        _study.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(_study_open == false){
                    _study_open = true;
                    _study_view.post(new Frag_Second.result_study());
                }else{
                    _study_open = false;
                    _study_view.post(new Frag_Second.result_study());
                }
        ...
        _emotion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(_emotion_open == false){
                    _emotion_open = true;
                    _emotion_view.post(new Frag_Second.result_emotion());
                }else{
                    _emotion_open = false;
                    _emotion_view.post(new Frag_Second.result_emotion());
                }
        ...
        task.execute("http://172.30.1.12/query.php?table="+userId+"&date="+date+"&num=1"); //IP 주소 변경
        task_final.execute("http://172.30.1.12/queryfinal.php?table="+userId+"&date="+date+"&num=1");
